...
if __name__ == '__main__':
    ...
    classes = [i for i in range(800, 1000)]
    ...
    save_dir = 'reproduce/scale{}_eta{}_step{}/imagenet/w4a8/'.format(scale, ddim_eta, ddim_steps)
    if not os.path.exists(save_dir):
        os.makedirs(save_dir)
    torch.save(input_list, save_dir + 'imagenet_input_{}classes_3.pth'.format(len(classes)))
    sys.exit(0)
