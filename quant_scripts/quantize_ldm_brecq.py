...
if __name__ == '__main__':
    ...
    # cali_images, cali_t, cali_y = get_calibration_set('reproduce/scale1.5_eta1.0_step250/imagenet/w4a8/data/imagenet_input_1000classes.pth')
    ...
    cali_images, cali_t, cali_y = dntc_sample('reproduce/scale1.5_eta1.0_step250/imagenet/w4a8/imagenet_input_1000classes.pth')
    ...
    torch.save(qnn.state_dict(), 'reproduce/scale1.5_eta1.0_step250/imagenet/w{}a{}/weights/quantw{}_ldm_brecq_dntc_1000classes.pth'.format(n_bits_w, n_bits_a, n_bits_w))
