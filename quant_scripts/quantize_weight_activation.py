...
if __name__ == '__main__':
    ...
    # if resample calibration
    # cali_images, cali_t, cali_y = resample_calibration('scale3.0_eta0.0_step20/imagenet/w4a8/imagenet_input_1000classes_dataset.pth')
    ...
    ckpt = torch.load('scale3.0_eta0.0_step20/imagenet/w4a8/weights/quantw4_ldm_1000classes.pth', map_location='cpu') ## replace first step checkpoint here
    ...
    torch.save(qnn.state_dict(), 'scale3.0_eta0.0_step20/imagenet/w4a8/weights/quantw{}a{}_ldm_1000classes.pth'.format(n_bits_w, n_bits_a))
