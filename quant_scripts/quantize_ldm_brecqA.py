...
from quant_scripts.quant_dataset import get_calibration_set, DiffusionInputDataset
...
if __name__ == '__main__':
    ...
    ckpt = torch.load('scale3.0_eta1.0_step20/imagenet/w8a8/weights/quantw8_ldm_brecq_dntc_1000classes.pth', map_location='cpu') ## replace first step checkpoint here
    ...
    torch.save(qnn.state_dict(), 'scale3.0_eta1.0_step20/imagenet/w8a8/weights/quantw{}a{}_ldm_brecq_dntc_1000classes.pth'.format(n_bits_w, n_bits_a))
