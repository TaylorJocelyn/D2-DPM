...
if __name__ == '__main__':
    # dntc_sample('reproduce/scale3.0_eta1.0_step20/imagenet/w4a8/imagenet_input_1000classes.pth')
    dntc_sample('reproduce/scale1.5_eta1.0_step250/imagenet/w4a8/imagenet_input_1000classes.pth')
