...
if __name__ == '__main__':
    ...
    cali_images, cali_t, cali_y = dntc_sample('reproduce/scale3.0_eta0.0_step20/imagenet/w4a8/imagenet_input_1000classes_dataset.pth')
    # cali_images, cali_t, cali_y = get_calibration_set('reproduce/scale3.0_eta0.0_step20/imagenet/w4a8/imagenet_input_1000classes_dataset.pth')
#    cali_images, cali_t, cali_y = get_train_samples(data_loader, num_samples=1024)
    ...
    ckpt = torch.load('reproduce/scale3.0_eta0.0_step20/imagenet/w4a8/weights/quantw{}a{}_ldm_brecq_dntc_1000classes.pth'.format(n_bits_w, n_bits_a), map_location='cpu')
    ...
    image_to_save.save("reproduce/scale{}_eta0.0_step{}/imagenet/w{}a{}/save_data/dntc_correct_3347.png".format(scale, ddim_steps, n_bits_w, n_bits_a, n_bits_w,n_bits_a, ddim_steps, ddim_eta, scale))
    torch.save(all_samples, "reproduce/scale{}_eta0.0_step{}/imagenet/w{}a{}/save_data/dntc_correct_3347.pth".format(scale, ddim_steps, n_bits_w, n_bits_a, n_bits_w,n_bits_a, ddim_steps, ddim_eta, scale))
