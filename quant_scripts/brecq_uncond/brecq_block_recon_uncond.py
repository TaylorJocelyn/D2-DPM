...
from quant_scripts.brecq_uncond.brecq_data_utils_uncond import save_grad_data, save_inp_oup_data_block, save_inp_oup_data


def block_reconstruction_two_input(model: QuantModel, block, cali_images:torch.Tensor, cali_t:torch.Tensor,
    ...
    cached_inps0, cached_inps1, cached_outs = save_inp_oup_data_block(model, block, cali_images, cali_t, asym, act_quant, batch_size)
    if opt_mode != 'mse':
