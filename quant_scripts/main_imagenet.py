...
if __name__ == '__main__':
    ...
    image_to_save.save("reproduce/scale{}_eta{}_step{}/imagenet/save_data/fp32_{}.png".format(scale, ddim_eta, ddim_steps, seed))
    torch.save(all_samples, "reproduce/scale{}_eta{}_step{}/imagenet/save_data/fp32_{}.pth".format(scale, ddim_eta, ddim_steps, seed))
