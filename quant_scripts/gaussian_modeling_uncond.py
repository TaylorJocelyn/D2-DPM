...
def tensor_wise_gaussian_model():
    data_error_t_list = torch.load('reproduce/lsun_{}_eta{}_step{}/w{}a{}/data/data_error_t_w{}a{}_eta{}_step{}.pth'.format(data_type, ddim_eta, ddim_steps, n_bits_w, n_bits_a, n_bits_w, n_bits_a, ddim_eta, ddim_steps), map_location='cpu')  ## replace error file here
    data_list = []
    error_list = []
    t_list = []
    quant_list = []
    ...
    np.save("reproduce/lsun_{}_eta{}_step{}/w{}a{}/gaussian_correct/mu_dict.npy".format(data_type, ddim_eta, ddim_steps, n_bits_w, n_bits_a), mu_dict, allow_pickle=True)
    np.save("reproduce/lsun_{}_eta{}_step{}/w{}a{}/gaussian_correct/cov_dict.npy".format(data_type, ddim_eta, ddim_steps, n_bits_w, n_bits_a), cov_dict, allow_pickle=True)
...
def channel_wise_gaussian_model():
    ...
    np.save("reproduce/lsun_{}_eta{}_step{}/w{}a{}/channel_wise_gaussian_correct/mu_dict.npy".format(data_type, ddim_eta, ddim_steps, n_bits_w, n_bits_a), mu_dict, allow_pickle=True)
    np.save("reproduce/lsun_{}_eta{}_step{}/w{}a{}/channel_wise_gaussian_correct/cov_dict.npy".format(data_type, ddim_eta, ddim_steps, n_bits_w, n_bits_a), cov_dict, allow_pickle=True)
