...
def main():
    ...
    if args.correct_type != 'fp32':
        ...
        cali_images, cali_t, cali_y = get_calibration_set('reproduce/scale{}_eta{}_step{}/imagenet/w4a8/data/imagenet_input_1000classes.pth'.format(scale, ddim_eta, ddim_steps))
        # cali_images, cali_t, cali_y = get_train_samples(data_loader, num_samples=1024)
        # cali_images, cali_t, cali_y = dntc_sample('scale3.0_eta1.0_step20/imagenet/w4a8/imagenet_input_1000classes_dataset.pth')
        ...
        ckpt = torch.load('reproduce/scale{}_eta{}_step{}/imagenet/w{}a{}/weights/quantw{}a{}_ldm_brecq_1000classes.pth'.format(scale, ddim_eta, ddim_steps, n_bits_w, n_bits_a, n_bits_w, n_bits_a), map_location='cpu')
        print('load ckpt: reproduce/scale{}_eta{}_step{}/imagenet/w{}a{}/weights/quantw{}a{}_ldm_brecq_1000classes.pth'.format(scale, ddim_eta, ddim_steps, n_bits_w, n_bits_a, n_bits_w, n_bits_a))
    ...
    if args.correct_type == 'fp32' or  args.correct_type == 'ptq4dm':
    ...
    out_path = os.path.join('evaluate_data/scale{}_eta{}_steps{}'.format(scale, ddim_eta, ddim_steps), f"{args.correct_type}_{args.num_samples}_steps{ddim_steps}_eta{ddim_eta}_scale{scale}_w{n_bits_w}a{n_bits_a}_2.npz")
